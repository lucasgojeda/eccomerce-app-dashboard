...
export const registerPage = (sm, md, lg, xl) => {
  switch (true) {

    case sm:
      return register__smBox();

    case md:
      return register__mdBox();

    case lg:
      return register__lgBox();

    case xl:
      return register__xlBox();
