...
export const DialogDelete = () => {
  ...
  const handleDelete = () => {
    ...
    Swal.fire({
      position: "center",
      icon: "info",
      title: `You cannot use this option on demo version!`,
    ...
    //   case "/bin/products":
    //     startUiOpenErrorAlert(
    //       "La opción de eliminar definitivamente un producto está desactivada en la versión de prueba"
    //     );
    //     break;

    //   case "/bin/users":
    //     startUiOpenErrorAlert(
    //       "La opción de eliminar definitivamente un usuario está desactivada en la versión de prueba"
    //     );
    //     break;

    //   case "/regist":
    //     startUiOpenErrorAlert(
    //       "La opción eliminar todos los registros está desactivada en la versión de prueba"
    //     );
    //     break;
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to perform this action? Could be irreversible
          </DialogContentText>
        </DialogContent>
        <DialogActions>
